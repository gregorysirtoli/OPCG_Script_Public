...
def generate_record_sale_post() -> None:
    from private_providers.blog import getBlog as blog

    print("[Orchestrator] Starting record sale generation workflow")
    print("[Orchestrator] Provider module: private_providers.blog.getBlog")
...
if __name__ == "__main__":
    ...
    try:
        ...
        subject = "✅ [1/1][BLOG] Blog generation completed"
        body = (
        ...
        send_email("🚫 [1/1][BLOG] Blog generation failed", traceback.format_exc())
